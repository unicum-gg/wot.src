package net.wg.infrastructure.base.meta.impl
{
   ...
   public class DamagePanelMeta extends BattleLayoutComponent
   {
      ...
      public final function as_setup(param1:String, param2:int, param3:String, param4:Array, param5:Array, param6:Boolean, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : void
      {
         var _loc11_:Array = this._array;
         this._array = param4;
         var _loc12_:Array = this._array1;
         this._array1 = param5;
         this.setup(param1,param2,param3,this._array,this._array1,param6,param7,param8,param9,param10);
         if(_loc11_)
         {
      ...
      protected function setup(param1:String, param2:int, param3:String, param4:Array, param5:Array, param6:Boolean, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean) : void
      {
         var _loc11_:String = "as_setup" + Errors.ABSTRACT_INVOKE;
         DebugUtils.LOG_ERROR(_loc11_);
         throw new AbstractException(_loc11_);
      }
   }
}
