...
class Comp7ShopController(IComp7ShopController):
    ...
    def hasNewDiscounts(self, newRank):
        ...
        prevRankDiscounts = {k:v for k, v in viewitems(prevRankDiscounts) if v > 0 if v > 0}
        currentRankDiscounts = {k:v for k, v in viewitems(currentRankDiscounts) if v > 0 if v > 0}
