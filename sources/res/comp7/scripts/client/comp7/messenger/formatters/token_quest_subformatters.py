...
class Comp7RewardsFormatter(SyncTokenQuestsSubFormatter):
    ...
    def __formatQualificationRewardMessage(self, message, questIDs):
        ranksQuests = {q for q in questIDs if comp7_quest_helpers.getComp7QuestType(q) == Comp7QuestType.RANKS if comp7_quest_helpers.getComp7QuestType(q) == Comp7QuestType.RANKS}
