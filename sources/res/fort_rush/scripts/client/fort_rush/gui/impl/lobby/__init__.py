...
def getViewSettings():
    ...
    return (
     ViewSettings(FORT_RUSH_HANGAR_ALIASES.FORT_RUSH_HANGAR_WITH_AMMUNITION, FortRushHangarWindow, '', WindowLayer.SUB_VIEW, FORT_RUSH_HANGAR_ALIASES.FORT_RUSH_HANGAR_WITH_AMMUNITION, ScopeTemplates.LOBBY_SUB_SCOPE),
     ViewSettings(FORT_RUSH_HANGAR_ALIASES.FORT_RUSH_BATTLE_RESULTS, FortRushPostBattleResultsWindow, '', WindowLayer.SUB_VIEW, FORT_RUSH_HANGAR_ALIASES.FORT_RUSH_BATTLE_RESULTS, ScopeTemplates.LOBBY_SUB_SCOPE))
