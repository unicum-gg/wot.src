...
class SetProgressCounterSettings(ClientBattleHUDWidgetSettings):
    ...
    _SETTINGS_CONFIG = [
     PropertySlotSpec('header', SLOT_TYPE.STR, required=True),
     PropertySlotSpec('icon', SLOT_TYPE.STR, editorData=['shield', 'swords', 'wave'], required=True)]
...
class SetEnemyListSettings(ClientBattleHUDWidgetSettings):
    ...
    _SETTINGS_CONFIG = [
     PropertySlotSpec('showSpottedIcon', SLOT_TYPE.BOOL, defaultValue=True),
     PropertySlotSpec('highlightElite', SLOT_TYPE.BOOL, defaultValue=False)]


class SetPrimaryObjectiveSettings(ClientBattleHUDWidgetSettings):
    _ICONS = [
     'flagFailure', 'flagSuccess']
    _SETTINGS_MODEL = settings.primary_objective.PrimaryObjectiveClientModel
    _WIDGET_TYPE = WidgetType.PRIMARY_OBJECTIVE
    _SETTING_TYPE = SettingType.ITEM
    _SETTINGS_CONFIG = [
     PropertySlotSpec('header', SLOT_TYPE.STR),
...
class SetAllyListSettings(ClientBattleHUDWidgetSettings):
    ...
    _SETTING_TYPE = SettingType.GENERAL
    _SETTINGS_CONFIG = [
     PropertySlotSpec('showFrags', SLOT_TYPE.BOOL, defaultValue=True),
     PropertySlotSpec('showVehicleTypeIcon', SLOT_TYPE.BOOL, defaultValue=False),
     PropertySlotSpec('highlightElite', SLOT_TYPE.BOOL, defaultValue=False)]
...
class SetMinimapSettings(ClientBattleHUDWidgetSettings):
    ...
    _SETTING_TYPE = SettingType.GENERAL
    _SETTINGS_CONFIG = [
     PropertySlotSpec('showGrid', SLOT_TYPE.BOOL),
...
class SetPrebattleCountdownSettings(ClientBattleHUDWidgetSettings):
    ...
    _SETTINGS_CONFIG = [
     PropertySlotSpec('header', SLOT_TYPE.STR, required=True),
     PropertySlotSpec('subheader', SLOT_TYPE.STR),
     PropertySlotSpec('battleStartMessage', SLOT_TYPE.STR, required=True)]
...
class SetChatSettings(ClientBattleHUDWidgetSettings):
    ...
    _SETTING_TYPE = SettingType.GENERAL
    _SETTINGS_CONFIG = [
     PropertySlotSpec('hide', SLOT_TYPE.BOOL, defaultValue=False)]
...
class SetRespawnHUDSetting(ClientBattleHUDWidgetSettings):
    ...
    _SETTING_TYPE = SettingType.GENERAL
    _SETTINGS_CONFIG = [
     PropertySlotSpec('showLivesInAlliesList', SLOT_TYPE.BOOL),
