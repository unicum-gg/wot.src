...
class AbilityContextClient(VehicleContextClient):
    ...
    @vse_event_out(display_name='OnActivated', description='Calls when ability activated', aspects=[
     ASPECT.CLIENT])
    def active(self):
        pass

    @vse_event_out(display_name='OnCooldown', description='Calls when ability becomes cooldown', aspects=[
     ASPECT.CLIENT])
    def cooldown(self):
        pass

    @vse_event_out(display_name='OnStartupCooldown', description='Calls when ability delayed before it can be activated', aspects=[
     ASPECT.CLIENT])
    def startupCooldown(self):
        pass

    @vse_event_out(display_name='OnInterrupted', description='Calls when interrupted by player', aspects=[
     ASPECT.CLIENT])
    def interrupted(self):
        pass

    @vse_event_out(display_name='OnExhausted', description='Calls when ability becomes exhausted', aspects=[
     ASPECT.CLIENT])
    def exhausted(self):
        pass

    @vse_event_out(display_name='OnPrepared', description='Calls when ability becomes preparing', aspects=[
     ASPECT.CLIENT])
    def preparing(self):
        pass

    @vse_event_out(display_name='OnCleanup', description='Calls when ability becomes cleanup', aspects=[
     ASPECT.CLIENT])
    def cleanup(self):
        pass

    @vse_event_out(display_name='OnUnavailable', description='Calls when ability unavailable', aspects=[
     ASPECT.CLIENT])
    def unavailable(self):
        pass

    @vse_event_out(display_name='OnDeploying', description='Calls when ability becomes deploying', aspects=[
     ASPECT.CLIENT])
    def deploying(self):
        pass
