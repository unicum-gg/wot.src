...
_OVERLAY_PATTERN_KEYS = ('overlayForeground', 'overlay', 'destructibleForeground',
                         'destructible')
_OVERLAY_TARGET_INDEXES = {'enemy': 1, 'friend': 2}
g_instance = None
...
class EdgeDetectColorController(object):
    ...
    def __changeColor(self, diff):
        ...
        colorsSet = (
         colors['hangar'] if isHangar else colors['self'],
