...
PROTO_TYPE_NAMES = {v:k for k, v in viewitems(PROTO_TYPE.__dict__) if not k.startswith('_') if not k.startswith('_')}
...
USER_ACTION_ID_NAMES = {v:k for k, v in viewitems(USER_ACTION_ID.__dict__) if not k.startswith('_') if not k.startswith('_')}
...
CLIENT_ERROR_NAMES = {v:k for k, v in viewitems(CLIENT_ERROR_ID.__dict__) if not k.startswith('_') if not k.startswith('_')}
...
CLIENT_ACTION_NAMES = {v:k for k, v in viewitems(CLIENT_ACTION_ID.__dict__) if not k.startswith('_') if not k.startswith('_')}
