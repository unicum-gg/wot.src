...
CONTACT_ERROR_NAMES = {v:k for k, v in viewitems(CONTACT_ERROR_ID.__dict__) if not k.startswith('_') if not k.startswith('_')}
...
LIMIT_ERROR_NAMES = {v:k for k, v in viewitems(LIMIT_ERROR_ID.__dict__) if not k.startswith('_') if not k.startswith('_')}
...
CHANNEL_ERROR_NAMES = {v:k for k, v in viewitems(CHANNEL_ERROR_ID.__dict__) if not k.startswith('_') if not k.startswith('_')}
...
MUC_CREATION_ERROR_NAMES = {v:k for k, v in viewitems(MUC_CREATION_ERROR.__dict__) if not k.startswith('_') if not k.startswith('_')}
