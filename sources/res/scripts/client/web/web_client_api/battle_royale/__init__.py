...
BattleRoyaleSeasonAchievements = namedtuple('BattleRoyaleSeasonAchievements', ('season_id',
                                                                               'episode_id',
                                                                               'battle_count',
                                                                               'kill_count',
                                                                               'top1'))
...
class BattleRoyaleWebApi(W2CSchema):
    ...
    def __validateSeasonData(self, seasonID, cycleID):
        ...
        seasonValidationData = {season.getSeasonID():[ cycle.ID for cycle in season.getAllCycles().values() ] for season in seasons if season is not None if season is not None}
