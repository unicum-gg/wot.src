...
class RestBonusController(IRestBonusController, IGlobalListener):
    ...
    def __hasQuestQueueType(quest, queueType):
        ...
        if bonusTypesCond is None:
            ...
            questQueueTypes = {ARENA_BONUS_TYPE_TO_QUEUE_TYPE[bonusType] for bonusType in bonusTypesCond.getValue() if bonusType in ARENA_BONUS_TYPE_TO_QUEUE_TYPE if bonusType in ARENA_BONUS_TYPE_TO_QUEUE_TYPE}
