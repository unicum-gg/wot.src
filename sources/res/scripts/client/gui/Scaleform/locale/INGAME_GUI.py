...
class INGAME_GUI(object):
    ...
    CHAT_SHORTCUTS_GLOBAL_MSG_ATK_SAVE_TANKS = '#ingame_gui:chat_shortcuts/global_msg_atk_save_tanks'
    CHAT_SHORTCUTS_GLOBAL_MSG_DEF_SAVE_TANKS = '#ingame_gui:chat_shortcuts/global_msg_def_save_tanks'
    CHAT_SHORTCUTS_GLOBAL_MSG_ATK_TIME = '#ingame_gui:chat_shortcuts/global_msg_atk_time'
    CHAT_SHORTCUTS_GLOBAL_MSG_DEF_TIME = '#ingame_gui:chat_shortcuts/global_msg_def_time'
    CHAT_SHORTCUTS_GLOBAL_MSG_LANE_WEST = '#ingame_gui:chat_shortcuts/global_msg_lane_west'
    CHAT_SHORTCUTS_GLOBAL_MSG_LANE_CENTER = '#ingame_gui:chat_shortcuts/global_msg_lane_center'
    CHAT_SHORTCUTS_GLOBAL_MSG_LANE_EAST = '#ingame_gui:chat_shortcuts/global_msg_lane_east'
    CHAT_SHORTCUTS_GLOBAL_MSG_ATK_FOCUS_HQ = '#ingame_gui:chat_shortcuts/global_msg_atk_focus_hq'
    CHAT_SHORTCUTS_GLOBAL_MSG_DEF_FOCUS_HQ = '#ingame_gui:chat_shortcuts/global_msg_def_focus_hq'
    ...
    CHAT_EXAMPLE_GLOBAL_MSG_DEF_SAVE_TANKS = '#ingame_gui:chat_example/global_msg_def_save_tanks'
    MARKER_METERS = '#ingame_gui:marker/meters'
    CHAT_EXAMPLE_GLOBAL_MSG_ATK_SAVE_TANKS = '#ingame_gui:chat_example/global_msg_atk_save_tanks'
    CHAT_EXAMPLE_GLOBAL_MSG_ATK_TIME = '#ingame_gui:chat_example/global_msg_atk_time'
    CHAT_EXAMPLE_GLOBAL_MSG_DEF_TIME = '#ingame_gui:chat_example/global_msg_def_time'
    CHAT_EXAMPLE_GLOBAL_MSG_LANE_WEST = '#ingame_gui:chat_example/global_msg_lane_west'
    CHAT_EXAMPLE_GLOBAL_MSG_LANE_CENTER = '#ingame_gui:chat_example/global_msg_lane_center'
    CHAT_EXAMPLE_GLOBAL_MSG_LANE_EAST = '#ingame_gui:chat_example/global_msg_lane_east'
    CHAT_EXAMPLE_GLOBAL_MSG_ATK_FOCUS_HQ = '#ingame_gui:chat_example/global_msg_atk_focus_hq'
    CHAT_EXAMPLE_GLOBAL_MSG_DEF_FOCUS_HQ = '#ingame_gui:chat_example/global_msg_def_focus_hq'
