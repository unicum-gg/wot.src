...
class ShellParamsSwitcherWidget(ShellParamsSwitcherWidgetMeta, ContainersListener, IMechanicStatesListenerLogic):
    ...
    def _getViewUpdaters(self):
        return [
         VehicleMechanicPassengerUpdater(VehicleMechanicKeys.SHELL_PARAMS_SWITCHER, self),
         VehicleMechanicStatesUpdater(VehicleMechanicKeys.SHELL_PARAMS_SWITCHER, self),
