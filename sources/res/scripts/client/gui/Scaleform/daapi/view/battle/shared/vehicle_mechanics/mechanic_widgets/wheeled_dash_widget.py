...
class WheeledDashMechanicWidget(WheeledDashWidgetMeta, ContainersListener, IMechanicStatesListenerLogic):
    ...
    def _getViewUpdaters(self):
        return [
         VehicleMechanicPassengerUpdater(VehicleMechanicKeys.WHEELED_DASH, self),
         VehicleMechanicStatesUpdater(VehicleMechanicKeys.WHEELED_DASH, self),
         VehicleMechanicCommandsUpdater(VehicleMechanicKeys.WHEELED_DASH, self),
