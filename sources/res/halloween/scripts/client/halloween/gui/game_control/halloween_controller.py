...
class _HalloweenConfig(namedtuple('_HalloweenConfig', ('isEnabled', 'isBattlesEnabled', 'startDate', 'endDate',
                                ...
                                'isPromoScreenEnabled', 'isIntroVideoEnabled', 'isOutroVideoEnabled',
                                'isInfoPageEnabled', 'isInfoMetaEnabled', 'modeSelectorShowRewards',
                                'twitch_con', 'prominentBonus', 'battleQueue'))):
    __slots__ = ()
