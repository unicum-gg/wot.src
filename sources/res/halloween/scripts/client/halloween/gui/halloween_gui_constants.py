...
class VIEW_ALIAS(views.VIEW_ALIAS, ConstInjector):
    ...
    HALLOWEEN_BATTLE_RESULTS = 'hwBattleResults'
...
HALLOWEEN_VEHICLE_FEATURE_TOOLTIP = 'halloweenVehicleFeatureTooltip'
