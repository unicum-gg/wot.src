...
class HWBattleRibbonsPanel(BattleRibbonsPanel):
    onRibbonHidden = Event.Event()

    def __init__(self):
        super(HWBattleRibbonsPanel, self).__init__()
        self._ribbonsAggregator = ribbons_aggregator.createRibbonsAggregator()
        battleEfficiencyTypes = [ ribbon.TYPE for ribbon in ribbons_aggregator.HWReceiveDamageRibbonsFactory.ATTACK_REASONS.values() ]
    ...
    def onHide(self, ribbonId):
        self.onRibbonHidden(self._ribbonsAggregator.getRibbon(ribbonId))
        super(HWBattleRibbonsPanel, self).onHide(ribbonId)
    ...
    def _getRibbonsConfig(self):
        ...
        result.extend([
         ...
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_SHOT_AOE_DAMAGE,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.instantShotAoeDamage())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_SHOT_AOE_DRAIN_ENEMY_HP,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.instantShotAoeDrainEnemyHp())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_SHOT_AOE_STUN,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.instantShotAoeStun())],
         [
         ...
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_SHELLS_RECEIVE,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.shellsReceived())],
         [
         ...
         [
          ...
          backport.text(R.strings.halloween_battle.efficiencyRibbons.aoeDamage())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_IGNITE_DAMAGE_RECEIVED,
          backport.text(R.strings.ingame_gui.efficiencyRibbons.deathZone())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_STUN_DAMAGE_RECEIVED,
          backport.text(R.strings.ingame_gui.efficiencyRibbons.deathZone())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_DAMAGE_OVERTIME_RECEIVED,
          backport.text(R.strings.ingame_gui.efficiencyRibbons.deathZone())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_CORROSION_DAMAGE,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.corrosionDamage())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_STOMPING_DAMAGE,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.stompingDamage())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_HANGAR_ITEMS_PICKUP,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.secretReward())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_HANGAR_ITEMS_RECEIVE,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.secretRewardReceive())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_SOULS_PICKUP,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.soulsPickup())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_SOULS_RECEIVE,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.soulsReceive())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_SOULS_DRAINED,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.soulsDrained())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_SOULS_REFUND,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.soulsRefund())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_ANOMALY_PICKUP,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.anomalyPickup())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_ANOMALY_RECEIVE,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.anomalyReceive())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_BOMBER_RESIST,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.buffBomberResist())],
         [
          HW_BATTLE_EFFICIENCY_TYPES.HALLOWEEN_INSTANT_KILL,
          backport.text(R.strings.halloween_battle.efficiencyRibbons.buffInstakill())]])
        return result
