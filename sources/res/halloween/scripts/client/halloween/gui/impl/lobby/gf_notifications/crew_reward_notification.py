...
class CrewRewardNotification(NotificationBase):
    ...
    def __init__(self, resId, *args, **kwargs):
        ...
        self._filterState = FilterState(initialState={FilterState.GROUPS.TANKMANKIND.value: TankmanKind.RECRUIT.value}, persistor=Persistor(storageKey='barracks', persistentGroups=[
