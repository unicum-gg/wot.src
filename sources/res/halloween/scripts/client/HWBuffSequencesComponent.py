...
@groupComponent(sequences=ListParam(valueParam=ObjParam(sequence=StrParam(), bindNode=StrParam(), offset=Vector3Param(), scale=Vector3Param(default=(1.0,
                                                                                                                                                     1.0,
                                                                                                                                                     1.0)), rotationYPR=Vector3Param(), loopCount=IntParam(default=-1), autoStart=BoolParam(default=True), visibleTo=StrParam(default='all'), sniperModeVisibleTo=StrParam(default='all'), checkNodeExists=BoolParam(default=False))))
class HWBuffSequencesComponent(HWBuffEffectComponentCommon):
    ...
    def _createGameObject(self, queue, bindNode='', transform=Math.Matrix()):
        if self._hasAppearance:
